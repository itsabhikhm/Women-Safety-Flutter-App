...
import 'package:women_safety_final_project/child/bottom_screens/contacts/MyContacts.dart';

import 'bottom_screens/chat_page.dart';
import 'bottom_screens/contacts/phonebook_view.dart';
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                ...
                child: Image.asset("assets/contact.png", height: 28),
              ),
              Padding(
              ...
              InkWell(
                ...
                child: Image.asset("assets/chat.png", height: 28),
              ),
              InkWell(
                onTap: () {
                  if (currentPage != 3)
                ...
                child: Image.asset("assets/chat_r.png", height: 28),
              ),
            ],
          ),
        ),
